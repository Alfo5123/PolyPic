...
class Triangle(object):
    ...
    def randomize(self):
        ...
        new_center_x_0 = int(self.points[0][0] + np.random.normal(0, 30))
        new_center_y_0 = int(self.points[0][1] + np.random.normal(0, 30))

        new_center_x_1 = int(self.points[1][0] + np.random.normal(0, 30))
        new_center_y_1 = int(self.points[1][1] + np.random.normal(0, 30))

        new_center_x_2 = int(self.points[2][0] + np.random.normal(0, 30))
        new_center_y_2 = int(self.points[2][1] + np.random.normal(0, 30))
        ...
        self.points = ( (max(0, min(self.width, new_center_x_0)),
                       max(0, min(self.height, new_center_y_0))),
                       (max(0, min(self.width, new_center_x_1)),
                       max(0, min(self.height, new_center_y_1))),
                       (max(0, min(self.width, new_center_x_2)),
                       max(0, min(self.height, new_center_y_2))))
