...
class Triangle ( object ):
    ...
    def __init__( self , *args ):
        ...
        def randomize(self):
            ...
            new_center_x_0 = int(self.center[0][0] + np.random.normal(0, 5))
            new_center_y_0 = int(self.center[0][1] + np.random.normal(0, 5))

            new_center_x_1 = int(self.center[1][0] + np.random.normal(0, 5))
            new_center_y_1 = int(self.center[1][1] + np.random.normal(0, 5))

            new_center_x_2 = int(self.center[2][0] + np.random.normal(0, 5))
            new_center_y_2 = int(self.center[2][1] + np.random.normal(0, 5))
            ...
            self.center = (max(0, min(self.width, new_center_x_0)),
